...
def train(opt, device):
    ...
    if RANK in {-1, 0} and final_epoch:
        LOGGER.info(
            ...
            f"\nPredict:         python classify/predict.py --weights1 {best} --source im.jpg"
            f"\nValidate:        python classify/val.py --weights1 {best} --data {data_dir}"
            f"\nExport:          python export.py --weights1 {best} --include onnx"
...
def parse_opt(known=False):
    ...
    parser.add_argument("--model", type=str, default="yolov5s-cls.pt", help="initial weights1 path")
