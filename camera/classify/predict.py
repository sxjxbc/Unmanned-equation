...
Usage - sources:
    $ python classify/predict.py --weights1 yolov5s-cls.pt --source 0                               # webcam
                                                                   img.jpg                         # image
                                                                   vid.mp4                         # video
                                                                   screen                          # screenshot
                                                                   path/                           # directory
...
Usage - formats:
    $ python classify/predict.py --weights1 yolov5s-cls.pt                 # PyTorch
...
def parse_opt():
    ...
    parser.add_argument("--weights1", nargs="+", type=str, default=ROOT / "yolov5s-cls.pt", help="model path(s)")
