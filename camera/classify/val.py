...
Usage:
    ...
    $ python classify/val.py --weights1 yolov5m-cls.pt --data ../datasets/imagenet --img 224  # validate ImageNet

Usage - formats:
    $ python classify/val.py --weights1 yolov5s-cls.pt                 # PyTorch
...
def parse_opt():
    ...
    parser.add_argument("--weights1", nargs="+", type=str, default=ROOT / "yolov5s-cls.pt", help="model.pt path(s)")
