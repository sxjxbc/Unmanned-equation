...
Usage:
    $ python models/tf.py --weights1 yolov5s.pt

Export:
    $ python export.py --weights1 yolov5s.pt --include saved_model pb tflite tfjs
"""
...
class TFBN(keras.layers.Layer):
    """TensorFlow BatchNormalization wrapper for initializing with optional pretrained weights1."""

    def __init__(self, w=None):
        """Initializes a TensorFlow BatchNormalization layer with optional pretrained weights1."""
        super().__init__()
...
class TFConv(keras.layers.Layer):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, act=True, w=None):
        ...
        Inputs are ch_in, ch_out, weights1, kernel, stride, padding, groups.
        """
        super().__init__()
...
class TFDWConv(keras.layers.Layer):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, act=True, w=None):
        ...
        Input are ch_in, ch_out, weights1, kernel, stride, padding, groups.
        """
        super().__init__()
...
def run(
    weights=ROOT / "yolov5s.pt",  # weights1 path
...
def parse_opt():
    """Parses and returns command-line options for model inference, including weights1 path, image size, batch size, and
    dynamic batching.
    """
    parser = argparse.ArgumentParser()
    parser.add_argument("--weights1", type=str, default=ROOT / "yolov5s.pt", help="weights1 path")
