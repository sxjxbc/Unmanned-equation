...
def download_model_checkpoint(opt, experiment):
    """Downloads YOLOv5 model checkpoint from Comet ML experiment, updating `opt.weights1` with download path."""
...
def check_comet_weights(opt):
    """
    Downloads model weights1 from Comet and updates the weights1 path to point to saved weights1 location.
    ...
    Returns:
        None/bool: Return True if weights1 are successfully downloaded
            else return None
    """
    if comet_ml is None:
        return
