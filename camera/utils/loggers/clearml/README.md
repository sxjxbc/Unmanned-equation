...
python train.py --img 640 --batch 16 --epochs 3 --data coco128.yaml --weights1 yolov5s.pt --cache
```
...
python train.py --project my_yolo_project --name experiment_001 --img 640 --batch 16 --epochs 3 --data coco128.yaml --weights1 yolov5s.pt --cache
```
...
python train.py --img 640 --batch 16 --epochs 3 --data clearml://YOUR_DATASET_ID --weights1 yolov5s.pt --cache
```
